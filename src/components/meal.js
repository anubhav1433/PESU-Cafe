...
import myimg from '../img/logo.jpg';
import burger from '../img/burger.jpg';
import PANEER from '../img/paneerroll.jpg';
    ...
    render() {
        return (
            <div id="bill" onChange={this.totalcost}>
                <Food img={myimg} name="BUN SAMOSA" price="30" ref={this.pizza} />
                <Food img={burger} name="BURGER" price="50" ref={this.burger} />
                <Food img={PANEER} name="PANEER ROLL" price="50" ref={this.roll} />
