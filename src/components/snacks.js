...
import myimg from '../img/kurkure.jpg';
import burger from '../img/bhel.jpg';
import PANEER from '../img/cheese.jpg';
    ...
    render() {
        return (
            <div id="bill" onChange={this.totalcost}>
                <Food img={myimg} name="KURKURE" price="20" ref={this.pizza} />
                <Food img={burger} name="BHEL PURI" price="30" ref={this.burger} />
                <Food img={PANEER} name="CHEESE MAGGIE" price="30" ref={this.roll} />
